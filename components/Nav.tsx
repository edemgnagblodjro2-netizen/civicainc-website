      ...
      <div className="hidden md:block" style={{ background: "#0a1730" }}>
        <div className="max-w-7xl mx-auto px-6 h-9 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.45)" }}>
            ...
            {/* X */}
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-white" style={{ color: "rgba(255,255,255,0.45)" }}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
