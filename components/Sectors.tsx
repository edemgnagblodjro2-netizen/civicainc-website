  ...
  return (
    <section className="bg-white py-24 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-px bg-slate-100 border border-slate-100">
          {items.map((item) => (
            <div
              key={item.label}
              className="bg-white px-5 py-7 flex flex-col items-start gap-4 hover:bg-slate-50 transition-colors"
            >
              <span className="text-slate-400">
                {SECTOR_ICONS[item.label] ?? (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
